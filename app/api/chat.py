...
Dual-Model Strategy:
  POST /ask            → gemini-1.5-flash (fast, ~2-3s)  — Q&A chat
...
# ---------------------------------------------------------------
# POST /ask — Quick Q&A (gemini-1.5-flash)
# ---------------------------------------------------------------
@router.post("/ask")
async def ask_agronomist_api(
    ...
    Menggunakan gemini-1.5-flash untuk respons cepat (~2-3 detik).
    ...
    return {"status": "success", "model": "gemini-1.5-flash", "answer": answer}
